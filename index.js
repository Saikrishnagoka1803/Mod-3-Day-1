...
const largestOf3 = function (l, m, n) {
  if (l > m && l > n) {
    ...
    console.log(
      `${l}, ${m}, ${n}  may be first two parameters are equal as you see`,
      ` so largest is ${l}`
    );
  }
};
...
const rangefor = function (k, l) {
  if ((k >= 40 && k <= 60) || (k >= 70 && k <= 100)) {
    if (k >= 40 && k <= 60) console.log(`${k} is in range 40 to 60`);
    else console.log(`${k} is in range 70 to 100`);
  } else console.log(`${k} is out of inclusives`);
  if ((l >= 40 && l <= 60) || (l >= 70 && l <= 100)) {
    if (l >= 40 && l <= 60) console.log(`${l} is in range 40 to 60`);
    else console.log(`${l} is in range 70 to 100`);
  } else console.log(`${l} is out of inclusives`);
};
rangefor(43, 44);
rangefor(23, 78);
...
const contains1or3 = function (a) {
  if (a.length === 2) {
    ...
    else console.log(`array of ${a} doesnt contain 1 or 3`);
  } else console.log(`sorry!! we deal with only arrays of length 2 as asked`);
};
contains1or3([2, 3]);
contains1or3([2, 4]);
contains1or3([1, 3]);
...
const doesntcontains1or3 = function (a) {
  if (a.length === 2) {
    ...
    else console.log(`array of ${a} contain 1 or 3`);
  } else console.log(`sorry!! we deal with only arrays of length 2, as asked`);
};
...
const longestString = function (array1) {
  ...
  for (let j = 0; j < array1.length; j++) {
    if (array1[j].length === k) console.log(array1[j]);
  }
};
...
const findAngles = function (ang) {
  ang =
    ang >= 0 && ang < 90
      ...
      : ang >= 90 && ang < 180
      ? console.log("Abtuse Angle")
      : ang === 180
      ? console.log("Straight Angle")
      : console.log("Angle greater than 180 degrees");
};
findAngles(45);
findAngles(91);
findAngles(181);
...
const negAndPos = function (nums) {
  if (nums.length === 2) {
    ...
    else console.log("not as expected");
  } else console.log("as asked!! we deal only arrays with length 2");
};
negAndPos([23, -46]);
negAndPos([-23, 23]);
negAndPos([-46, -46]);
...
upperthree("hello world");
upperthree("h ello world");
...
const intresting = function (inte) {
  ...
  else if (collect.includes(3)) console.log("Diego");
  else if (collect.includes(5)) console.log("Ricardo");
  else if (collect.includes(7)) console.log("Miceli");
  else console.log(`${inte}`);
};
